...
const columnGroupingModel = [
  ...
  },
  {
    ...
    freeReordering: true,
    children: [{ field: 'planannual' }, { field: 'realannual' }, {field: 'rpannual'} ],
  },
  {
    groupId: 'First',
...
export default function GoalsTableDatagrid( handleOpenModalDetails , isDisableSelectionOnClick , hasCheckbox , isLoading ) {
  return (
    <div style={{ height: 700, width: '100%' }}>
      <StyledDataGrid
       onRowClick={handleOpenModalDetails && ((params) => handleOpenModalDetails(params.rows))}
       loading={isLoading}
        rows={rows}
        columns={columns}
