...
import DialogSuccess from "./records/DialogSuccess";

//MODAL PRE-DELETE
import DeleteFoda from "./records/DeleteFoda";
...
function FodaActual() {
  ...
  const { takeFodaToContext, form, setForm, cargarFodaDeLocalStorage } =
  ...
  //PARA ESTABLECER AÑO (por ahora inhabilitado)
  ...
  //Text for modal
  const diagnosticSubtitle = `El mismo estará disponible en la pestaña F.O.D.A. ${anioActual} y podras editarlo las veces que sientas necesarias`;
  const diagnosticTitle = "¡F.O.D.A. GUARDADO CON EXITO!";
  const buttonPrimaryText = "VER F.O.D.A.";

  //MODAL PRE-DELETE
  const [openDeleteFoda, setOpenDeleteFoda] = useState(false);
  const titlePreDeleteFoda = "¿ELIMINAMOS EL F.O.D.A.?";
  const subtitleDeleteFoda =
    "Perderas toda la inforación de este año y tendras que crear una nueva";
  ...
  function removeTagOportunidadesActual(index) {
    edit &&
      setOportunidadesActual(
        oportunidadesActual.filter((el, i) => i !== index)
      );
  }
  ...
  return (
    <Box sx={{ width: "100%" }}>
      ...
      >
        ...
        >
          <button
            type="button"
            style={buttonStyle}
            onClick={handleEditarActual}
          >
            <FaEdit style={{ marginRight: "5px" }} />
            EDITAR
          </button>
          <button style={buttonStyle} onClick={handleEliminarActual}>
      ...
      >
        ...
        >
          <Box sx={{ display: "flex", flexDirection: "column", width: "100%" }}>
            <Typography
              variant="h6"
              sx={{ fontWeight: "bold", fontSize: 15, marginLeft: 2 }}
            >
              FORTALEZAS
            </Typography>
            ...
            >
              {fortalezasActual.map((tag, index) => (
                ...
                >
                  ...
                  <Box
                    ...
                    onClick={() => removeTagFortalezasActual(index)}
                  >
                    {edit && "x"}
                  </Box>
                </Box>
              ...
              {edit && (
                <input
                  ...
                  onKeyDown={handleKeyDownActualFortalezas}
                ></input>
              )}
            </Box>
          </Box>
            ...
            >
              {oportunidadesActual.map((tag, index) => (
                ...
                >
                  ...
                  <Box
                    ...
                    onClick={() => removeTagOportunidadesActual(index)}
                  >
                    {edit && "x"}
                  </Box>
                </Box>
              ...
              {edit && (
                <input
                  ...
                  className="tag-input"
                  placeholder="Escribir y pulsar Enter para confirmar..."
                  onKeyDown={handleKeyDownActualOportunidades}
                ></input>
              )}
            </Box>
          </Box>
            ...
            >
              {debilidadesActual.map((tag, index) => (
                ...
                >
                  ...
                  <Box
                    ...
                    onClick={() => removeTagDebilidadesActual(index)}
                  >
                    {edit && "x"}
                  </Box>
                </Box>
              ...
              {edit && (
                <input
                  ...
                  className="tag-input"
                  placeholder="Escribir y pulsar Enter para confirmar..."
                  onKeyDown={handleKeyDownActualDebilidades}
                ></input>
              )}
            </Box>
          </Box>
            ...
            >
              {amenazasActual.map((tag, index) => (
                ...
                >
                  ...
                  <Box
                    ...
                    onClick={() => removeTagAmenazasActual(index)}
                  >
                    {edit && "x"}
                  </Box>
                </Box>
              ...
              {edit && (
                <input
                  ...
                  className="tag-input"
                  placeholder="Escribir y pulsar Enter para confirmar..."
                  onKeyDown={handleKeyDownActualAmenazas}
                ></input>
              )}
            </Box>
          </Box>
        ...
        <Box sx={{ display: "flex", flexDirection: "row", marginTop: "10px" }}>
          <button style={buttonStyle} onClick={handleSubmitActual}>
            GUARDAR
          </button>
          <button style={buttonStyle} onClick={handleCancelActual}>
            CANCELAR
          </button>
        </Box>
      </Box>
      ...
      />
      <DeleteFoda
        openDeleteFoda={openDeleteFoda}
        title={titlePreDeleteFoda}
        subtitle={subtitleDeleteFoda}
        setOpenDeleteFoda={setOpenDeleteFoda}
      />
    </Box>
  );
}
